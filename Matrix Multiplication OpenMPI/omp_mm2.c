 ...
 * 
 * Linux Servers:
 * Compile: gcc -g -Wall -fopenmp -o omp_mm2 omp_mm2.c
 * Run: ./omp_mm2 <thread_count> <size of matrix>
 * 
 * Expanse Cluster:
 * 1. Load Intel compiler: module load intel mvapich2
 * 2. Compile code: icc -o mm2 omp_mm2.c -qopenmp
 * 3. Submit job script: sbatch mm2Script.sb
 * 
